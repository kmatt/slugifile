...
// 	if lastFile.Path != "/Users/ewilan/Workspace/go_tools/slugifile/misc/listing/nested/La Quête d'Ewilan vol.1 D'un monde à l'autre.md" {
// 		t.Errorf("Expected /Users/ewilan/Workspace/go_tools/slugifile/misc/listing/nested/La Quête d'Ewilan vol.1 D'un monde à l'autre.md, got %s", lastFile.Path)
// 	}
